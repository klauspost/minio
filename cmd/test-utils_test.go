...
func init() {
	// Auto-encryption turned-off for tests
	os.Unsetenv(crypto.EnvAutoEncryptionLegacy)

	// Auto-encryption turned-off for tests
	os.Unsetenv(crypto.EnvKMSAutoEncryption)

	// Unset local access/secret keys from tests.
	os.Unsetenv(config.EnvAccessKey)
	os.Unsetenv(config.EnvSecretKey)

	// Unset local access/secret keys old from tests.
